  ...
  return (
    <>
      ...
      <div className="inline-flex shadow-sm rounded-md h-8" role="group">
        <button
          type="button"
          className="rounded-md bg-blue-800/60 text-sm font-medium  mx-1 px-6 text-white text-center hover:text-blue-200 focus:z-10 focus:ring-blue-200 focus:bg-blue-400"
